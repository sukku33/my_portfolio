<!DOCTYPE hhome__descriptiontml>
   ...
   <body>
      ...
      <header class="header" id="header">
         <nav class="nav container">
            <a href="#" class="nav__logo">
               <img src="./assets/img/logo-pizza.svg" alt="img">
               Pizzaroma
            </a>
            ...
            <div class="product__container container grid">
               <article class="products__card">
                  ...
                  <button class="products__button">
                     <i class="ri-shopping-bag-3-fill add-to-cart"></i>
                  </button>
               </article>
               ...
               <article class="products__card">
                  <img src="./assets/img/product-6.png" alt="image" class="products__img">

                  <h3 class="products__name">Neapolitan <br> Pizza</h3>
                  <span class="products__price">$13</span>
               ...
               <div class="contact__data">
                  ...
                  <div class="contact__info grid">
                     ...
                     <div>
                        ...
                        <a href="https://maps.app.goo.gl/WvFVG2UZ5bDciR7f9" target="_blank" class="contact__map">
      ...
      <div id="cart-window" class="cart-window">
         <h3>Your Cart 🛒</h3>
          <div id="cart-window-items"></div>
        <p id="total">Total : $<span id="cart-window-total">0.00</span></p>
...
:root {
  ...
  --shadow-small-img: drop-shadow(0 4px 16px hsla(353, 100%, 8%, .1));
...
C:\Users\karna\OneDrive\Desktop\pizza\responsive-pizza-website-main\responsive-pizza-website-main\assets\img
...
function updateCart() {
  const cartItemsContainer = document.getElementById('cart-window-items')
  const cartTotal = document.getElementById('cart-window-total')
...
function getProductData(card) {
  const image = card.querySelector('.products__img').src
  const name = card.querySelector('.products__name').innerText
  const priceText = card.querySelector('.products__price').innerText
...
window.addEventListener('DOMContentLoaded', () => {
  document.querySelectorAll('.add-to-cart').forEach(icon => {
    icon.addEventListener('click', () => {
      const card = icon.closest('.products__card')
      const { image, name, price } = getProductData(card)
